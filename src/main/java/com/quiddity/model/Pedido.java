...
public class Pedido {
    ...
    /**
     * Estados posibles del pedido en orden de flujo normal:
    ...
    public Pedido(int id, int usuarioId, int direccionId, Estado estado,
            double total, String notas,
            ZonedDateTime creadoEn, ZonedDateTime actualizadoEn) {
        this.id = id;
