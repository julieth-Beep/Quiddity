            ...
            <header id="main-header"
                ...
                <div class="flex items-center gap-12">
                    <a href="<%= ctx %>/index.jsp">
                        <h1 class="font-display-lg text-headline-md tracking-[0.2em] text-primary uppercase">Quiddity
                        </h1>
                    </a>
                ...
                <section id="catalog-hero" aria-label="Catálogo hero">
                    ...
                    <div class="relative z-10 h-full flex flex-col justify-end pb-14 px-container-margin">
                        <div id="hero-text-wrapper">
                            <span id="hero-label"
                                class="block font-label-md text-[10px] tracking-[0.35em] text-white/70 uppercase mb-4">
                                Explora nuestra selección
                            </span>
                            <h2 id="hero-title" class="font-display-lg text-white italic mb-3 leading-tight"
                                style="font-size:clamp(32px,4vw,56px);">
                                Todo el Catálogo
                            </h2>
                    ...
                    <div class="max-w-[1440px] mx-auto px-container-margin">
                        ...
                        <div class="chips-scroll py-5 gap-3">
                            <button class="cat-chip active" data-cat="all"
                                data-hero-bg="<%= ctx %>/uploads/catalogo/heroSection/card1.jpeg"
                            ...
                            <button class="cat-chip" data-cat="belleza"
                                data-hero-bg="<%= ctx %>/uploads/catalogo/heroSection/card2.jpg"
                                ...
                                <span class="material-symbols-outlined"
                                    style="font-size:14px;">face_retouching_natural</span>
                                Belleza
                            </button>
                            <button class="cat-chip" data-cat="cuidado"
                                data-hero-bg="<%= ctx %>/uploads/catalogo/heroSection/card3.png"
                    ...
                    <div class="flex justify-between items-end">
                        <div>
                            <span id="section-label"
                                class="font-label-md text-label-md text-primary uppercase tracking-[0.2em] mb-3 block">
                                Todos los productos
                            </span>
                        ...
                        <!-- Guest notice -->
                        <div
                            class="hidden md:flex items-center gap-3 border border-outline/20 px-5 py-3 bg-surface-variant/50">
                            ...
                            <a href="<%= ctx %>/login.jsp"
                                class="font-label-md text-[11px] uppercase tracking-widest text-primary hover:underline ml-2">
                                Login →
                            </a>
                        </div>
                    </div>
                ...
                <section class="max-w-[1440px] mx-auto px-container-margin pb-section-gap">
                    <div id="product-grid" class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-gutter">
                        ...
                        <div class="product-card group cursor-pointer" data-cat="belleza" data-subcat="brochas">
                            <div class="aspect-[4/5] overflow-hidden bg-surface-variant mb-5 relative">
                                <img alt="Set de Brochas Profesional"
                                    ...
                                    src="<%= ctx %>/uploads/catalogo/heroSection/card1.jpeg" />
                                <span
                                    class="absolute top-3 left-3 bg-white font-label-md text-[9px] tracking-[0.2em] uppercase px-3 py-1 text-on-surface">Nuevo</span>
                            </div>
                            <div class="flex justify-between items-start">
                                <div>
                                    <p class="font-label-md text-[10px] text-on-surface-variant uppercase mb-1">Brochas
                                    </p>
                                    <h4
                                        class="font-headline-md text-[18px] leading-tight mb-2 group-hover:text-primary transition-colors">
                                        Set Profesional</h4>
                                    <p class="font-body-md text-primary text-sm">$78.000</p>
                                </div>
                                <button onclick="openLoginPrompt()"
                                    class="w-9 h-9 rounded-full border border-outline/20 flex items-center justify-center hover:bg-primary hover:text-white transition-all mt-1">
                        ...
                        <div class="product-card group cursor-pointer" data-cat="belleza" data-subcat="esponjas">
                            ...
                            <div class="flex justify-between items-start">
                                <div>
                                    <p class="font-label-md text-[10px] text-on-surface-variant uppercase mb-1">Esponjas
                                    </p>
                                    <h4
                                        class="font-headline-md text-[18px] leading-tight mb-2 group-hover:text-primary transition-colors">
                                        Botanical Blender</h4>
                        ...
                        <div class="product-card group cursor-pointer" data-cat="cuidado" data-subcat="mascarillas">
                            <div class="aspect-[4/5] overflow-hidden bg-surface-variant mb-5 relative">
                                <img alt="Mascarilla de Arcilla Rosa"
                                    class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000"
                        ...
                        <div class="product-card group cursor-pointer" data-cat="cuidado" data-subcat="serums">
                            ...
                            <div class="flex justify-between items-start">
                                <div>
                                    <p class="font-label-md text-[10px] text-on-surface-variant uppercase mb-1">Serums
                                    </p>
                                    <h4
                                        class="font-headline-md text-[18px] leading-tight mb-2 group-hover:text-primary transition-colors">
                                        Radiance Elixir</h4>
                        ...
                        <div class="product-card group cursor-pointer" data-cat="cuidado" data-subcat="hidratantes">
                            <div class="aspect-[4/5] overflow-hidden bg-surface-variant mb-5 relative">
                                <img alt="Crema Regeneradora Nocturna"
                                    class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000"
                    ...
                    <div id="lock-cta" class="relative mt-0 -mx-container-margin overflow-hidden"
                        style="height: 220px; margin-top: -120px;">
                        <div class="absolute inset-0"
                            style="background: linear-gradient(to top, rgba(255,255,255,1) 0%, rgba(255,255,255,0.85) 55%, rgba(255,255,255,0) 100%);">
                        </div>
                        <div class="absolute bottom-0 inset-x-0 flex flex-col items-center pb-8 gap-4">
                            <div class="flex items-center gap-2 text-on-surface-variant">
                                <span class="material-symbols-outlined text-primary">lock</span>
                                <p class="font-label-md text-[11px] uppercase tracking-[0.2em]">Inicia sesión para ver
                                    el catálogo completo</p>
                            </div>
...
═══════════════════════════════════════════ -->
                <section id="guest-cta" class="py-20 px-container-margin text-center">
                    <span class="font-label-md text-[10px] tracking-[0.4em] text-white/60 uppercase mb-6 block">Únete a
                        Quiddity</span>
                    <h2 class="font-display-lg text-white italic mb-6 leading-tight"
                        style="font-size: clamp(28px,4vw,52px);">
                        Accede a beneficios exclusivos
                    </h2>
                    <p class="font-body-md text-white/60 max-w-lg mx-auto mb-10 text-sm">
                        Miembros registrados disfrutan de descuentos personalizados, acceso anticipado a nuevas
                        colecciones, consultas con expertos y mucho más.
                    </p>
                    <div class="flex flex-wrap justify-center gap-4 mb-14">
                        <div class="flex items-center gap-2 text-white/80">
                            ...
                            <span class="font-label-md text-[11px] uppercase tracking-widest">Descuentos
                                exclusivos</span>
                        </div>
                        ...
                        <div class="flex items-center gap-2 text-white/80">
                            ...
                            <span class="font-label-md text-[11px] uppercase tracking-widest">Consultas
                                personalizadas</span>
                        </div>
                        <div class="w-px h-4 bg-white/20 self-center hidden md:block"></div>
                        <div class="flex items-center gap-2 text-white/80">
                            <span class="material-symbols-outlined" style="font-size:16px;">local_shipping</span>
                            <span class="font-label-md text-[11px] uppercase tracking-widest">Envío gratis
                                prioritario</span>
                        </div>
                    </div>
...
═══════════════════════════════════════════ -->
            <footer class="bg-white border-t border-on-surface/5 py-24 px-container-margin">
                ...
                <div
                    ...
                    <p class="text-[10px] font-label-md text-on-surface-variant/60 uppercase tracking-[0.2em]">© 2026
                        QUIDDITY SKINCARE. ALL RIGHTS RESERVED.</p>
...
═══════════════════════════════════════════ -->
            <div id="login-modal" class="fixed inset-0 z-[100] hidden items-center justify-center"
                style="background: rgba(28,27,29,0.55); backdrop-filter: blur(4px);">
                <div class="bg-white max-w-md w-full mx-4 p-12 relative">
                    <button onclick="closeLoginPrompt()"
                        class="absolute top-5 right-5 text-on-surface-variant hover:text-on-surface transition-colors">
                        <span class="material-symbols-outlined">close</span>
                    </button>
                    <span class="block font-label-md text-[10px] tracking-[0.35em] text-primary uppercase mb-6">Acceso
                        requerido</span>
                    <h3 class="font-display-lg text-headline-md italic text-on-surface mb-4 leading-tight">Crea tu
                        cuenta para comprar</h3>
                    <p class="font-body-md text-sm text-on-surface-variant mb-8 leading-relaxed">
                        Los invitados pueden explorar nuestro catálogo, pero para añadir productos al carrito, guardar
                        favoritos y disfrutar de ofertas exclusivas, necesitas una cuenta gratuita.
                    </p>
...
═══════════════════════════════════════════ -->
            <script>
                ...
                function closeAnnouncementBar() {
                    ...
                    document.querySelectorAll('.sticky').forEach(el => { el.style.top = '72px'; });
                }
                ...
                function filterProducts() {
                    ...
                    var subObj = activeSubcat && SUBCATS[activeCat] ? SUBCATS[activeCat].find(function (s) { return s.key === activeSubcat; }) : null;
                ...
                function updateHero(btn) {
                    ...
                    var heroBg = document.getElementById('catalog-hero-bg');
                    var heroWrapper = document.getElementById('hero-text-wrapper');
