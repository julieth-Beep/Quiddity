                                ...
                                <div class="profile-avatar" id="avatarPreview">
                                    <c:choose>
                                        <c:when test="${not empty sessionScope.usuario.fotoPerfil}">
                                            <%-- FIX: Usar /foto-perfil/ en lugar de /uploads/perfiles/ --%>
                                            <img src="${pageContext.request.contextPath}/foto-perfil/${sessionScope.usuario.fotoPerfil}" alt="Foto de perfil">
                                        </c:when>
                                        <c:otherwise>
